  ...
  return (
    <main className={styles.shell}>
      <header className={styles.header}>
        ...
        <nav><a href="/staff/orders">Orders</a><a href="/staff/customers">Customers</a><a href="/staff/resellers">Resellers</a><a className={styles.active} href="/staff/team">Team</a></nav>
