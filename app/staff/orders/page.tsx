  ...
  return (
    <main className={styles.shell}>
      <header className={styles.header}>
        ...
        <div className={styles.account}><span>{role}</span><div>{user.displayName}<small>{user.email}</small></div>{role !== "worker" && <a href="/staff/customers">Customers</a>}{role !== "worker" && <a href="/staff/resellers">Resellers</a>}{role === "admin" && <a href="/staff/finance">Finance</a>}{role === "admin" && <a href="/staff/team">Team</a>}<a href={chatGPTSignOutPath("/")}>Sign out</a></div>
      </header>
